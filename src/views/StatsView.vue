...
<template>
  <BaseView title="Statistics">
    <div v-if="timeEntries.length > 0" class="space-y-6">
      ...
      <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.2fr_1fr]">
        <div class="rounded-xl border border-base-300 bg-base-100 p-5 shadow-sm">
          ...
          <div v-if="categoryBreakdown.length" class="grid grid-cols-1 gap-6 lg:grid-cols-[320px_1fr]">
    ...
    <div v-else class="mt-6 rounded-xl border border-dashed border-base-300 bg-base-100 p-6">
